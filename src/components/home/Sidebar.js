                    ...
                    <div className="scroll-sidebar">
                        ...
                        <nav className="sidebar-nav">_
                            <ul id="sidebarnav">
                                ...
                                <li> <a className="waves-effect waves-dark" href="/lap-phieu-dv" aria-expanded="false"><i className="fa fa-file" /><span className="hide-menu">Lập phiếu dịch vụ</span></a>
                                </li>
                                <li> <a className="waves-effect waves-dark" href="/lap-hoa-don" aria-expanded="false"><i className="fa fa-file" /><span className="hide-menu">Lập hóa đơn</span></a>
                                </li>
